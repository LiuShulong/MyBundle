...
// MyBundle
#define COCOAPODS_POD_AVAILABLE_MyBundle
#define COCOAPODS_VERSION_MAJOR_MyBundle 0
#define COCOAPODS_VERSION_MINOR_MyBundle 1
#define COCOAPODS_VERSION_PATCH_MyBundle 0
